...
export default class MyPlayer extends Player {
    ...
    update(playerSelector, cursors, keyE, keyR, network) {
        if (!cursors)
            return;
                    ...
                    this.scene.time.addEvent({
                        ...
                        callback: () => {
                            ...
                            if (chairItem.itemDirection) {
                                this.setPosition(chairItem.x + sittingShiftData[chairItem.itemDirection][0], chairItem.y + sittingShiftData[chairItem.itemDirection][1]).setDepth(chairItem.depth + sittingShiftData[chairItem.itemDirection][2]);
...
Phaser.GameObjects.GameObjectFactory.register('myPlayer', function (x, y, texture, id, frame) {
